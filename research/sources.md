...
| Measurement / ROI | Steffen Hedebrandt | CMO of Dreamdata, publishes B2B revenue attribution benchmarks from 3.5M+ customer journeys |
| B2B demand gen strategy | Liam Moroney | CEO of Storyboard, articulates dark social and brand-driven demand creation for B2B SaaS |
...
- **Credential**: Co-founder and CMO of Dreamdata (B2B revenue attribution platform). Winner of the LinkedIn Marketing Partner Award for B2B Thought Leadership (2026). Published the LinkedIn Ads Benchmarks Report analyzing 66M+ sessions across 3.5M+ B2B customer journeys.
- **Playbook dimension**: Measurement and ROI — how to attribute LinkedIn organic and paid activity to pipeline and revenue using real data, not vanity metrics
...
- **Credential**: Co-founder and CEO of Storyboard Marketing (B2B SaaS consultancy). 15+ years as marketing leader in-house at B2B startups before founding the agency. Host of "The B2B Brand" podcast. Contributor to MarTech.org.
- **Playbook dimension**: B2B demand generation strategy — why buying happens off-attribution, how brand memory drives consideration sets, and why the performance marketing mindset fails at top-of-funnel
